...
void MX_FREERTOS_Init(void) {
  /* USER CODE BEGIN Init */
    xTaskCreate(keySacnTask, "keyScanTask", 128, NULL, 1, NULL);
  xTaskCreate(logicTask, "logicTask", 128, NULL, 1, &logicTaskHandle);
